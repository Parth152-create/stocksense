...
export default function RegisterPage() {
  ...
  const strengthColor = ["", "#ef4444", "#f59e0b", "#8FFFD6"];
    ...
    <div className="min-h-screen flex bg-[#0a0a0a] text-white">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-[#111111] border-r border-[#1f1f1f] p-12">
        ...
        <div>
          ...
          <h1 className="text-5xl font-bold leading-tight text-white mb-6">
            Your portfolio,<br />intelligent.
          </h1>
          <p className="text-[#888888] text-base leading-relaxed max-w-sm">
            Join thousands of investors who use StockSense to make smarter, data-driven decisions.
          </p>
          ...
          <div className="mt-12 space-y-4">
            {[
              ...
              <div key={feature} className="flex items-center gap-3">
                <CheckCircle2 size={16} className="text-[#8FFFD6] shrink-0" />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          {success && (
            <div className="mb-6 text-sm text-[#8FFFD6] bg-[#8FFFD6]/10 border border-[#8FFFD6]/20 rounded-xl p-4 flex items-center gap-2">
                  ...
                  <div className="flex gap-1 mb-1">
                    {[1, 2, 3].map((level) => (
                      <div
                        ...
                        style={{
                          backgroundColor: strength >= level ? strengthColor[strength] : "#1f1f1f",
                        }}
                      />
                    ))}
                  </div>
          ...
          <p className="text-center text-[#444444] text-xs mt-6">
            ...
            <span className="text-[#8FFFD6] cursor-pointer hover:underline">Terms of Service</span>{" "}
            and{" "}
            <span className="text-[#8FFFD6] cursor-pointer hover:underline">Privacy Policy</span>
          </p>
        </div>
      </div>
    </div>
